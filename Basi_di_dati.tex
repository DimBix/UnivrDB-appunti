...
\titleformat{\section}[block]{\normalfont\fontsize{2em}{2em}\bfseries\filcenter}{\thesection}{10pt}{}
\titleformat{\subsection}[block]{\normalfont\fontsize{1.35em}{1em}\bfseries}{\thesubsection}{10pt}{}
...
% Cambia il comportamento del counter nei caption
\counterwithin{figure}{section} % Figures will be numbered as 1.1, 1.2, etc.
\captionsetup[figure]{labelformat=simple, labelsep=colon, name=Figura}
